...
struct UnaryOperation {
    ...
    static void call(Params& params) {
        params.r = Implementation::call(params.a);
    }

    static T call(T a) {
        return Implementation::call(a);
    }
};
