...
cd $env:BUILD_DIR
cmake -DCMAKE_BUILD_TYPE=Debug -DCMAKE_INSTALL_PREFIX=$env:INSTALL_DIR -DLLVM_TARGETS_TO_BUILD=X86 -DLLVM_ENABLE_PROJECTS=clang -G "Visual Studio 17 2022" -A x64 -Thost=x64 $env:SOURCE_DIR/llvm
cmake --build . 
cmake -DCMAKE_INSTALL_PREFIX="$env:INSTALL_DIR/Debug" -P cmake_install.cmake
...
# cmake --build . 
# cmake -DCMAKE_INSTALL_PREFIX="$env:INSTALL_DIR/Release" -P cmake_install.cmake
