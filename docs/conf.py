...
breathe_default_project = "lython"
breathe_projects = {
    'lython': doxygen_out_xml
}
...
latex_documents = [
  (master_doc, 'lython.tex', u'lython Documentation',
   u'Pierre Delaunay', 'manual'),
]
...
man_pages = [
    (master_doc, 'lython', u'lython Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'lython', u'lython Documentation',
   author, 'lython', 'Python C++ Implementation',
   'Miscellaneous'),
]
