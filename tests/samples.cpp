...
DEFINE_SAMPLE_CODE(simple_function_noargs, "def simple_function_noargs() -> e:\n"
                                           "    return 1\n"
                                           "\n")

DEFINE_SAMPLE_CODE(simple_function_docstring, "def simple_function_docstring(a: b, c: d) -> e:\n"
                                              "    \"\"\"This is a docstring\"\"\"\n"
                                              "    return 1\n"
                                              "\n")
...
DEFINE_SAMPLE_CODE(simple_function_return_args, "def simple_function_return_args(a) -> e:\n"
                                                "    return a\n"
                                                "\n")
DEFINE_SAMPLE_CODE(simple_function_max, "def simple_function_max(a: Float, b: Float) -> Float:\n"
                                        "    return max(a, b)\n"
                                        "\n")
DEFINE_SAMPLE_CODE(simple_function_global, "def simple_function_global(a: Float) -> Float:\n"
                                           "    return a + pi\n"
                                           "\n")
DEFINE_SAMPLE_CODE(function_call, "def add(a: Float, b: Float) -> Float:\n"
                                  "    return a + b\n"
                                  "\n"
                                  "def function_call() -> Float:\n"
                                  "    return add(1, 2)\n")

DEFINE_SAMPLE_CODE(max_alias, "def max_alias(a: Float, b: Float) -> Float:\n"
                              "   return max(a, b)\n"
                              "\n"
                   // "max_alias(1.0, 2.0)"
)

DEFINE_SAMPLE_CODE(simple_match, "def simple_match(a: bool) -> Float:\n"
                                 "    match a:\n"
                                 "        case true:\n"
                                 "            return false\n"
                                 "        case false:\n"
...
// Struct
// ------
DEFINE_SAMPLE_CODE(simple_struct, "struct a:\n"
                                  "    b: c\n"
                                  "\n")
DEFINE_SAMPLE_CODE(simple_struct_docstring, "struct a:\n"
                                            "    \"\"\"This is a docstring\"\"\"\n"
                                            "    b: c\n"
                                            "\n")

DEFINE_SAMPLE_CODE(struct_set_get, "struct Point:\n"
                                   "    x: Float\n"
                                   "    y: Float\n\n"
...
DEFINE_SAMPLE_CODE(from_import_call_code, "from a.b.c import g as h\n"
