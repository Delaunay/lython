...
Array<AllowEntry> allow_list = {
    ...
    {"BinOp", 4, 1},       {"IfExp", 0, 1},       {"Yield", 0, 1},       {"Yield", 1, 2},
    {"Yield", 1, 1},       {"YieldFrom", 0, 1},   {"Compare", 0, 1},     {"Compare", 0, 3},
    {"Compare", 0, 5},     {"Compare", 1, 1},     {"Compare", 2, 1},     {"Compare", 3, 1},
    {"Compare", 4, 1},     {"Call", 0, 1},        {"Attribute", 0, 1},   {"Subscript", 0, 1},
    {"TupleExpr", 0, 1},   {"TupleExpr", 0, 3},   {"TupleExpr", 1, 1},   {"TupleExpr", 0, 7},
    {"TupleExpr", 1, 7},   {"TupleExpr", 2, 1},   {"TupleExpr", 2, 3},   {"TupleExpr", 2, 5},
    {"TupleExpr", 2, 7},   {"TupleExpr", 2, 9},   {"Slice", 0, 1},       {"FunctionDef", 0, 30},
    {"Return", 0, 1},      {"Return", 1, 2},      {"Return", 1, 1},      {"Delete", 0, 2},
    ...
    {"AnnAssign", 3, 1},   {"AnnAssign", 2, 1},   {"AnnAssign", 0, 1},   {"AnnAssign", 1, 1},
    {"For", 0, 8},         {"For", 0, 9},         {"For", 0, 10},        {"For", 0, 15},
    {"For", 1, 16},        {"While", 0, 6},       {"While", 0, 7},       {"While", 0, 8},
    {"While", 0, 13},      {"If", 0, 6},          {"If", 0, 7},          {"If", 0, 8},
    {"If", 0, 14},         {"If", 0, 15},         {"If", 0, 16},         {"If", 0, 21},
    {"With", 0, 12},       {"Raise", 0, 1},       {"Raise", 0, 2},       {"Raise", 1, 1},
    {"Try", 0, 15},        {"Try", 0, 16},        {"Try", 0, 17},        {"Try", 0, 22},
    {"Try", 0, 23},        {"Try", 0, 24},        {"Try", 0, 29},        {"Assert", 1, 2},
    {"Import", 0, 2},      {"Import", 0, 4},      {"Import", 0, 6},      {"Import", 0, 8},
    {"Import", 1, 2},      {"Import", 0, 10},     {"Import", 0, 12},     {"ImportFrom", 0, 6},
    {"ImportFrom", 1, 4},  {"ImportFrom", 0, 8},  {"ImportFrom", 0, 10}, {"ImportFrom", 0, 12},
    {"ImportFrom", 1, 12}, {"ImportFrom", 1, 10}, {"ImportFrom", 1, 8},  {"ImportFrom", 1, 6},
    {"ImportFrom", 1, 16}, {"ImportFrom", 1, 14}, {"Match", 0, 15},      {"Match", 0, 16},
    {"Match", 0, 17},      {"Match", 0, 25},      {"Match", 0, 26},      {"Match", 0, 27},
    {"Match", 0, 28},      {"Match", 0, 36},      {"Match", 0, 37},      {"Match", 0, 38},
    {"Match", 0, 39},      {"Match", 0, 54},      {"Match", 0, 55},      {"Match", 0, 57},
    {"Match", 0, 59},      {"Match", 0, 60},      {"Match", 0, 61},      {"Match", 0, 69},
    {"Match", 0, 70},      {"Match", 1, 12},      {"Match", 1, 13},      {"Match", 1, 14},
    {"ClassDef", 1, 10},   {"ClassDef", 1, 11},   {"ClassDef", 1, 16},   {"ClassDef", 1, 17},
    {"ClassDef", 1, 20},   {"ClassDef", 1, 21},   {"ClassDef", 1, 22},   {"ClassDef", 1, 31},
    {"ClassDef", 1, 33},   {"ClassDef", 1, 35},   {"ClassDef", 1, 36},
};
